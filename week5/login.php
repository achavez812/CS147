...
<div data-role="page">
	...
	<p>
		...
		<form action="submit.php" id="someform" method="post">
		    <label>Username: <input class="forminput" type="text" name="name" /></label>
		    <label>Password: <input class="forminput" type="text" name="email" autocapitalize="off" /></label>
			<input type="submit" class="medium red awesome" value="Sign In" />
		</form>
